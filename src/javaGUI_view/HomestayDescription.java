...
public class HomestayDescription extends JFrame {
	...
	public HomestayDescription() {
		...
		lblOrchidSuite.setFont(new Font("Malgun Gothic Semilight", Font.BOLD | Font.ITALIC, 25));
		lblOrchidSuite.setBounds(500, 70, 225, 31);
		...
		tabbedPane.setBounds(23, 60, 330, 320);
		...
		lbl_Address.setBounds(373, 129, 189, 21);
		...
		lbl_PPN.setBounds(373, 189, 189, 31);
		...
		lbl_Facilities.setBounds(373, 249, 189, 21);
		...
		lbl_Max.setBounds(373, 309, 189, 21);
		...
		lbl_Bed.setBounds(373, 369, 189, 21);
		...
		lbl_Address_OS.setBounds(586, 129, 323, 57);
		...
		lbl_PPN_OS.setBounds(586, 194, 323, 21);
		...
		lbl_Facilities_OS.setBounds(586, 249, 323, 49);
		...
		lbl_Max_OS.setBounds(586, 309, 323, 21);
		...
		lbl_Bed_OS.setBounds(586, 369, 323, 21);
		...
		tabbedPane_1.setBounds(23, 61, 330, 320);
		...
		lblMagicStudio.setFont(new Font("Malgun Gothic Semilight", Font.BOLD | Font.ITALIC, 25));
		lblMagicStudio.setBounds(500, 71, 225, 31);
		...
		lbl_Address_1.setBounds(373, 130, 198, 21);
		...
		lbl_PPN_1.setBounds(373, 190, 198, 21);
		...
		lbl_Facilities_1.setBounds(373, 250, 198, 21);
		...
		lbl_Max_1.setBounds(373, 310, 198, 21);
		...
		lbl_Bed_1.setBounds(373, 370, 198, 21);
		...
		lbl_Bed_MS.setBounds(586, 370, 274, 21);
		...
		lbl_Max_MS.setBounds(586, 310, 274, 21);
		...
		lbl_Facilities_MS.setBounds(586, 250, 274, 50);
		...
		lbl_PPN_MS.setBounds(586, 190, 274, 21);
		...
		lbl_Address_MS.setBounds(586, 130, 274, 57);
		...
		tabbedPane_1_1.setBounds(22, 61, 330, 320);
		...
		lblDiamondHouse.setBounds(500, 70, 225, 30);
		...
		lbl_Address_2.setBounds(372, 140, 186, 21);
		...
		lbl_Address_OS_1_1.setBounds(585, 140, 365, 57);
		...
		lbl_PPN_2.setBounds(372, 200, 186, 21);
		...
		lbl_PPN_DH.setBounds(585, 200, 365, 21);
		...
		lbl_Facilities_2.setBounds(372, 260, 186, 21);
		...
		lbl_Facilities_DH.setBounds(585, 260, 365, 50);
		...
		lbl_Max_2.setBounds(372, 320, 186, 21);
		...
		lbl_Max_DH.setBounds(585, 320, 365, 21);
		...
		lbl_Bed_2.setBounds(372, 380, 186, 21);
		...
		lbl_Bed_DH.setBounds(585, 380, 365, 21);
